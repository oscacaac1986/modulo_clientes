            ...
            <div class="row vh-90 p-1">
                ...
                <div class="col-10">
                    <section id="informativo">
                        <div class="container-fluid hv-50 p-2 ">
                            <div class="row vh-50">
                                <div class="col-4">
                                    <div class="accordion">
                                        <div class="accordion-item bg-danger">
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse show text-light" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
